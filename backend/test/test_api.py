...
@pytest.mark.parametrize(
    "mockScandirReturn,shouldReturnNameList",
    [(e, s) for e, s in zip(mockDirEntries, shouldReturnNameList)],
)
...
@pytest.mark.parametrize(
    "mockScandirReturn,mockZipInfoList",
    [(e, z) for e, z in zip(mockDirEntries, mockZipInfoList)],
)
