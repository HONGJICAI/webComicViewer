...
export class ComicScrollViewContent extends React.Component<
  ComicScrollViewContentProps,
  ComicScrollViewContentState
> {
  comic: IComic;
  ...
  render() {
    ...
    const contents = pages.map((val, idx) => (
      <Img
        key={"Content" + this.comic.name + String(idx)}
